...
ExtScaffold.Abc = Ext.extend(Ext.Panel, {
  //
  ...
  activateForm: function(mode) {
    ...
    if(mode == 'new' || mode == 'edit') {
      ...
      fp.getForm().findField('abc[title]').focus(true, 400);
    }
  },
  
  getGridPanel: function() {
    return Ext.getCmp('abc-grid');
  },
  
  getFormPanel: function() {
    return Ext.getCmp('abc-form');
  },
  ...
  refreshFormToggle: function() {
    Ext.getCmp('abc-form-toggle').toggle(!this.getFormPanel().collapsed);
  },
  ...
  initComponent: function() {
    ...
    var ds = new Ext.data.Store({
      ...
      reader: new Ext.data.JsonReader({
                ...
                { name: 'id', mapping: 'abc.id' }
                ,{ name: 'abc[title]', mapping: 'abc.title' }
    ...
    var cm = new Ext.grid.ColumnModel([
      ...
      ,{ header: scaffoldPanel.labels['abc[title]'], dataIndex: 'abc[title]' }
    ...
    Ext.apply(this, {
      items: [{
        ...
        items: [
        { fieldLabel: scaffoldPanel.labels['abc[title]'], name: 'abc[title]', xtype: 'textfield' }
        ],
        ...
        onOk: function() {
          ...
          var submitOptions = {
            ...
            success: function(form, action) {
              ...
              scaffoldPanel.selectedRecordId = action.result.data['abc[id]'];
              scaffoldPanel.reloadStore(true);
            },
    ...
    ExtScaffold.Abc.superclass.initComponent.apply(this, arguments);
  },
  
  onRender: function() {
    ExtScaffold.Abc.superclass.onRender.apply(this, arguments);
